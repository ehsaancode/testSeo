...
const QTextH6 = ({
  ...
  // Observer for when QTextH6 enters the viewport
  useEffect(() => {
    ...
    if (H6Ref.current) {
      observer.observe(H6Ref.current);
    }

    return () => {
      if (H6Ref.current) {
        observer.unobserve(H6Ref.current);
      }
    };
...
export default QTextH6;
QTextH6.displayName = "QTextH6";
