...
const QTablePagination = ({
  ...
  const totalItemsValue = useSelector((state) =>
    state.pagination.globalSearch ||
    state.pagination.columnSearch == "Yes" ||
    state.pagination.filterSearch == "Yes"
      ? state.pagination.perPageCurrentData.length
  ...
  useEffect(() => {
    ...
    if (tablePaginationRef.current) {
      observer.observe(tablePaginationRef.current);
    }

    return () => {
      if (tablePaginationRef.current) {
        observer.unobserve(tablePaginationRef.current);
      }
    };
...
export default QTablePagination;
QTablePagination.displayName = "QTablePagination";
