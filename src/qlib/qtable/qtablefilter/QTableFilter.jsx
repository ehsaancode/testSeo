...
import { convertedWidth, convertedHeight, generateStyle } from "../../../utils/helper";
...
const QTableFilter = ({
  ...
  useEffect(() => {
    ...
    if (tableFilterRef.current) {
      observer.observe(tableFilterRef.current);
    }

    return () => {
      if (tableFilterRef.current) {
        observer.unobserve(tableFilterRef.current);
      }
    };
...
export default QTableFilter;
QTableFilter.displayName = "QTableFilter";
