...
const QTablePaginationButton = ({
  ...
  const tablePaginationButtonRef = useRef(null);
  ...
  useEffect(() => {
    ...
    if (tablePaginationButtonRef.current) {
      observer.observe(tablePaginationButtonRef.current);
    }

    return () => {
      if (tablePaginationButtonRef.current) {
        observer.unobserve(tablePaginationButtonRef.current);
      }
    };
...
QTablePaginationButton.propTypes = {
...
export default QTablePaginationButton;
QTablePaginationButton.displayName = "QTablePaginationButton";
