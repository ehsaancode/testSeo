...
const QTablePaginationInfo = ({
  ...
  const tablePaginationInfoRef = useRef(null);
  ...
  useEffect(() => {
    ...
    if (tablePaginationInfoRef.current) {
      observer.observe(tablePaginationInfoRef.current);
    }

    return () => {
      if (tablePaginationInfoRef.current) {
        observer.unobserve(tablePaginationInfoRef.current);
      }
    };
...
QTablePaginationInfo.propTypes = {
...
export default QTablePaginationInfo;
QTablePaginationInfo.displayName = "QTablePaginationInfo";
